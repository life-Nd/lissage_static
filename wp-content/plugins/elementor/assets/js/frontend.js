...
const swiperSource = elementorFrontendConfig.experimentalFeatures.e_swiper_latest ? `${elementorFrontendConfig.urls.assets}lib/swiper/v8/swiper${fileSuffix}.js` : `${elementorFrontendConfig.urls.assets}lib/swiper/swiper${fileSuffix}.js`;
AssetsLoader.assets = {
  script: {
    dialog: {
